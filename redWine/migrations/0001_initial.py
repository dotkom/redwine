...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'redWine_penalty', (
            ...
            ('committee', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('reason', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('item', self.gf('django.db.models.fields.CharField')(default='wine', max_length=30)),
            ('item_name', self.gf('django.db.models.fields.CharField')(default='vin', max_length=30)),
        ))
    ...
    models = {
        ...
        u'redWine.penalty': {
            ...
            'committee': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'giver': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'penaltygiver'", 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.CharField', [], {'default': "'wine'", 'max_length': '30'}),
            'item_name': ('django.db.models.fields.CharField', [], {'default': "'vin'", 'max_length': '30'}),
